...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pagen.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pagen.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.pagen.domain.User.class.getName());
            createCache(cm, com.pagen.domain.Authority.class.getName());
            createCache(cm, com.pagen.domain.User.class.getName() + ".authorities");
            createCache(cm, com.pagen.domain.Standard.class.getName());
