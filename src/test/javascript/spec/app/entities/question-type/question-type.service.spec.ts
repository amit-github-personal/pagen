...
describe('Service Tests', () => {
  describe('QuestionType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new QuestionType(123, 0, 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a QuestionType', async () => {
      ...
      it('should not update a QuestionType', async () => {
      ...
      it('should partial update a QuestionType', async () => {
      ...
      it('should not partial update a QuestionType', async () => {
      ...
      it('should not return a list of QuestionType', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a QuestionType', async () => {
