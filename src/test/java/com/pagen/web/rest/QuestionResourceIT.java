...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().name(DEFAULT_NAME).archived(DEFAULT_ARCHIVED);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().name(UPDATED_NAME).archived(UPDATED_ARCHIVED);
        return question;
    }
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getArchived()).isEqualTo(DEFAULT_ARCHIVED);
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        updatedQuestion.name(UPDATED_NAME).archived(UPDATED_ARCHIVED);
        ...
        assertThat(testQuestion.getArchived()).isEqualTo(UPDATED_ARCHIVED);
    }
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.name(UPDATED_NAME).archived(UPDATED_ARCHIVED);
